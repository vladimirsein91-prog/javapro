...
[![GitHub Actions Status](https://github.com/apache/commons-${commons.componentid}/workflows/Java%20CI/badge.svg)](https://github.com/apache/commons-${commons.componentid}/actions)
[![Coverage Status](https://codecov.io/gh/apache/commons-${commons.componentid}/branch/master/graph/badge.svg)](https://app.codecov.io/gh/apache/commons-${commons.componentid})
[![Maven Central](https://maven-badges.herokuapp.com/maven-central/ru.vtb/javapro/badge.svg?gav=true)](https://maven-badges.herokuapp.com/maven-central/ru.vtb/javapro/?gav=true)
[![Javadocs](https://javadoc.io/badge/ru.vtb/javapro/${commons.release.version}.svg)](https://javadoc.io/doc/ru.vtb/javapro/${commons.release.version})
[![CodeQL](https://github.com/apache/commons-${commons.componentid}/workflows/CodeQL/badge.svg)](https://github.com/apache/commons-${commons.componentid}/actions/workflows/codeql-analysis.yml?query=workflow%3ACodeQL)
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/apache/commons-${commons.componentid}/badge)](https://api.securityscorecards.dev/projects/github.com/apache/commons-${commons.componentid})

Проект для ДЗ по javaPro

Documentation
-------------

More information can be found on the [javaPro homepage](https://commons.apache.org/proper/commons-${commons.componentid}).
The [Javadoc](https://commons.apache.org/proper/commons-${commons.componentid}/apidocs) can be browsed.
Questions related to the usage of javaPro should be posted to the [user mailing list][ml].
...
Donations
---------
You like javaPro? Then [donate back to the ASF](https://www.apache.org/foundation/contributing.html) to support the development.
